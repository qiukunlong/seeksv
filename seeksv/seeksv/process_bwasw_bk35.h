...
public:
	...
	Alignment() { }
	Alignment(string chr1, int pos1, string left_seq1, string left_qual1, string right_seq1, string right_qual1, vector<pair<int, char> > &cigar_vec1, char clipped_side1)
	{
		chr = chr1;
		pos = pos1;
		left_seq = left_seq1;
	...
	void set_value(string chr1, int pos1, string left_seq1, string left_qual1, string right_seq1, string right_qual1, vector<pair<int, char> > &cigar_vec1, char clipped_side1)
	{
		chr = chr1;
		pos = pos1;
		left_seq = left_seq1;
